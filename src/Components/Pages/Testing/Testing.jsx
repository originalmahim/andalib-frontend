...
//         <div
//         className={`dropdown relative hidden lg:grid  ${isDropdownOpen ? 'open' : ''}`}
...
{
  user ? '' :
    <a href="/Login" className="btn rounded-full hidden px-6 bg-violet-400 text-white text-md lg:flex items-center gap-2 ">Login</a>
}
  </div>
 </div>
</div>
