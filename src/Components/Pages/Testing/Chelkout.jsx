...
const Chelkout = () => {
  ...
  const handleUpazilaChange = (e) => {
    setSelectedUpazila(e.target.value);
      ...
      <input required className="px-2 focus:outline-none focus:ring-2 focus:ring-gray-500 border-b border-gray-200 leading-4 text-base placeholder-gray-600 py-4 w-full" type="text" placeholder="আপনার সম্পুর্ন ঠিকানা লিখুন" />
      {/* Payment Options */}
<div className="mt-4">
  ...
  <div className="lg:flex items-center justify-center lg:space-x-4">
    ...
    <div className="flex items-center">
      <input type="radio" id="cash_on_delivery" name="payment_option" value="cash_on_delivery" onClick={() => openModal('cash_on_delivery')} />
      <label htmlFor="cash_on_delivery" className="ml-2 cursor-pointer">Cash on Delivery</label>
    </div>
    {/* Pay with Bkash/Nagad */}
    <div className="flex items-center">
      <input type="radio" id="bkash_nagad" name="payment_option" value="bkash_nagad" onClick={() => openModal('bkash_nagad')} />
  ...
  <div className="flex mt-7 flex-col items-end w-full space-y-6">
    ...
    <div className="flex items-center w-full space-x-4">
      ...
      <div>
        <p className="text-lg font-semibold leading-4 text-gray-800">Special Andalib Tote Bag</p>
      </div>
    </div>
  ...
  <div className=" mt-4 w-full items-center">
    ...
    <div className="flex items-center justify-between">
      <input type="text" placeholder="Enter Coupon Code" className="border border-gray-300 px-4 py-2 rounded-md focus:outline-none focus:border-blue-500" />
